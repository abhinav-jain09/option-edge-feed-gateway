...
/**
 * {@code GET /api/gamma-fragility?symbol&expiry} — the leader-fragility panel for one chain (GMS-R14).
 *
 ...
 */
@RestController
public class GammaFragilityController {
    ...
    public GammaFragilityController(FeedGatewayService service, LiquidityHistoryAuth auth,
                                   ObjectMapper mapper) {
    ...
    @GetMapping(value = "/api/gamma-fragility", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> gammaFragility(
        ...
        String cached = service.cachedGammaFragility(symbol, expiry);
